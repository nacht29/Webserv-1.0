...
class HTTP_Content_Type(Enum):
	...
	APPLICATION_VND_OPENXML_SPREADSHEETML_SHEET			= "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
	APPLICATION_VND_MS_POWERPOINT						= "application/vnd.ms-powerpoint"
	APPLICATION_VND_OPENXML_PRESENTATIONML_PRESENTATION	= "application/vnd.openxmlformats-officedocument.presentationml.presentation"
	APPLICATION_MSWORD									= "application/msword"
	APPLICATION_VND_OPENXML_WORDPROCESSINGML_DOCUMENT	= "application/vnd.openxmlformats-officedocument.wordprocessingml.document"
